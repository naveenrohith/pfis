...
| `GET` | `/api/auth/gmail/callback` | `code, state` | `303` | `400,409,500` | Stores encrypted connector tokens, resumes enabled auto-sync after reauthorization, and redirects to dashboard |
